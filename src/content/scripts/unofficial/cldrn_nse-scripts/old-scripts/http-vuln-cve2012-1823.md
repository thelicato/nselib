...
categories:
  ...
  - "vuln"
  - "intrusive"
shortDescription: "Detects PHP-CGI installations that are vulnerable to CVE-2012-1823, This vulnerability is critical and it allows attackers to retrieve source code and execute code remotely."
risk: intrusive
tags:
  - "exploit"
  - "vuln"
...
reference:
  ...
  url: "https://github.com/cldrn/nmap-nse-scripts/blob/master/old-scripts/http-vuln-cve2012-1823.nse"
---
