...
categories:
  - "discovery"
  - "intrusive"
shortDescription: "Determines if a web server is protected by an IPS (Intrusion Prevention System), IDS (Intrusion Detection System) or WAF (Web Application Firewall) by probing the web server with malicious payloads and detecting changes in the response code and body."
risk: intrusive
tags:
  - "discovery"
  - "intrusive"
...
reference:
  ...
  url: "https://github.com/cldrn/nmap-nse-scripts/blob/master/old-scripts/http-waf-detect.nse"
---
