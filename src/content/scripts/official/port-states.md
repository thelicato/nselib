...
categories:
  - "safe"
shortDescription: "Prints a list of ports found in each state."
risk: safe
tags:
  - "safe"
  - "hostrule"
...
protocols: []
ports: []
usage: "nmap -sV --script=port-states <target>"
outputPreview:
  - "Host script results:"
  - "| port-states:"
  - "|   tcp:"
...
reference:
  ...
  url: "https://svn.nmap.org/nmap/scripts/port-states.nse"
documentationUrl: "https://nmap.org/nsedoc/scripts/port-states.html"
---
