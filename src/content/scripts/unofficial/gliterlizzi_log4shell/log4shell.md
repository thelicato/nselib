...
categories:
  ...
  - "safe"
  - "external"
shortDescription: "Log4Shell - CVE-2021-44228"
risk: safe
tags:
  - "vuln"
  - "safe"
...
protocols: []
ports: []
usage: "nmap --script log4shell --script-args log4shell.callback-server=127.0.0.1:1389 -p <port> <host>"
outputPreview:
  - "PORT   STATE SERVICE"
  - "80/tcp open  http"
  - "| log4shell:"
  ...
  - "|   Path: /"
author: "Giuseppe Di Terlizzi <giuseppe DIT diterlizzi AT nttdata DOT com> (upstream: giterlizzi/nmap-log4shell)"
reference:
  label: "View Upstream Script Source"
  url: "https://github.com/giterlizzi/nmap-log4shell/blob/main/log4shell.nse"
---

Imported from the upstream repository [giterlizzi/nmap-log4shell](https://github.com/giterlizzi/nmap-log4shell).
