...
categories:
  ...
  - "intrusive"
  - "exploit"
shortDescription: "Exploits a remote code execution vulnerability in Awstats Totals 1.0 up to 1.14 and possibly other products based on it (CVE: 2008-3922)."
risk: intrusive
tags:
  - "vuln"
  - "intrusive"
...
reference:
  ...
  url: "https://github.com/cldrn/nmap-nse-scripts/blob/master/scripts/http-awstatstotals-exec.nse"
---
