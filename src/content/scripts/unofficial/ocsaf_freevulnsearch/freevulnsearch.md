...
categories:
  ...
  - "vuln"
  - "external"
shortDescription: "This script [Version 1.1.8] allows you to automatically search for CVEs using the API of\nhttps://www.circl.lu/services/cve-search/ in connection with the found CPEs\nusing the parameter -sV in NMAP."
risk: safe
tags:
  - "safe"
  - "vuln"
...
protocols: []
ports: []
usage: "nmap -sV --script freevulnsearch [--script-args apipath=<url>] <target>\nnmap -sV --script freevulnsearch [--script-args notls=yes] <target>\nnmap -sV --script freevulnsearch [--script-args summary=yes] <target>\nnmap -sV --script freevulnsearch [--script-args xmlhmtl=yes] <target>"
outputPreview: []
author: "Mathias Gut (upstream: OCSAF/freevulnsearch)"
reference:
  label: "View Upstream Script Source"
  url: "https://github.com/OCSAF/freevulnsearch/blob/master/freevulnsearch.nse"
---

Imported from the upstream repository [OCSAF/freevulnsearch](https://github.com/OCSAF/freevulnsearch).
