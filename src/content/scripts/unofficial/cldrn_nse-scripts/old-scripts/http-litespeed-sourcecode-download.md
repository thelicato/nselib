...
categories:
  ...
  - "intrusive"
  - "exploit"
shortDescription: "http-litespeed-sourcecode-download.nse exploits a null-byte poisoning vulnerability in Litespeed Web Servers 4.0.x before 4.0.15 to retrieve the target script's source code by sending a HTTP request with a null byte followed by a .txt file extension (CVE-2010-2333)."
risk: intrusive
tags:
  - "vuln"
  - "intrusive"
...
reference:
  ...
  url: "https://github.com/cldrn/nmap-nse-scripts/blob/master/old-scripts/http-litespeed-sourcecode-download.nse"
---
